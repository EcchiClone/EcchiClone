...
<a href="https://lit.link/ko/ecchiclone"><img src ="https://img.shields.io/badge/LinkTree-1de9b6?logo=linktree&logoColor=white" style="height : auto; margin-left : 2px; margin-right : 2px;"/></a>
...
## 🛠️ 대표 프로젝트들
1. <a href = "https://eclone-universe-web.vercel.app/">EClone Universe</a> - Next.js
2. <a href = "https://store.steampowered.com/app/2952090/Null_Reference_Exception/">Null Reference Exceptoin</a> - Unity
3. <a href = "https://www.youtube.com/watch?v=OP0JrZLFqz0">Youtube 온라인 자습실</a> - Unity, Youtube API, wss
4. <a href = "https://github.com/EcchiClone/Larayang-Assistant-Release">Larayang Assistant</a> - C#
5. <a href = "https://www.lalainfo.kr/">라라인포</a> - Node.js + Express, EJS, jQuery, ApexCharts
